...
for (i in 1: (length(args) / 2)) {
    variable_name <- paste("data", i)
    assign(variable_name, read.delim(args[0], FALSE, " "))
}
data1 <- read.delim(args[0], FALSE, " ")
data2 <- read.delim(args[1], FALSE, " ")
data3 <- read.delim(args[1], FALSE, " ")
data4 <- read.delim(args[1], FALSE, " ")
data5 <- read.delim(args[1], FALSE, " ")

dataCopulate1 <- read.delim("data_initf0_pplength01_1.dat", FALSE, " ")
dataCopulate2 <- read.delim("data_initf0_pplength01_2.dat", FALSE, " ")
dataCopulate3 <- read.delim("data_initf0_pplength01_3.dat", FALSE, " ")
dataCopulate4 <- read.delim("data_initf0_pplength01_4.dat", FALSE, " ")
dataCopulate5 <- read.delim("data_initf0_pplength01_5.dat", FALSE, " ")
...
png(file = "line_chart__mean_initf01_pplength09_1.jpg", width = 2000, height = 1000)
